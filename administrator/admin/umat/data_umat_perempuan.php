	...
	<div class="card-body">
		<div class="table-responsive">
			...
			<table id="example1" class="table table-bordered table-striped">
			  ...
			  left join tb_kk k on a.id_kk=k.id_kk left join tb_lingkungan c on p.id_lingkungan=c.id_lingkungan left join tb_stasi d on c.id_stasi=d.id_stasi inner join tb_kub b on p.id_kub=b.id_kub where status_umat='Ada' AND p.jenis_kelamin='PR'");

		...
		<div class="table-responsive">
			...
			<table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
					...
					$no = 1;
					$sql = $koneksi->query(
						"SELECT p.id_umat,p.id_kub, p.tanggal_lahir, p.nik, p.nama_umat, p.jenis_kelamin, p.alamat, p.rt, p.rw, a.id_kk, k.no_kk, k.kepala_keluarga, b.id_kub, b.nama_kub, c.id_lingkungan, c.nama_lingkungan, d.id_stasi, d.nama_stasi from 
			  			tb_umat p left join tb_anggota a on p.id_umat=a.id_umat 
			  left join tb_kk k on a.id_kk=k.id_kk left join tb_lingkungan c on p.id_lingkungan=c.id_lingkungan left join tb_stasi d on c.id_stasi=d.id_stasi inner join tb_kub b on p.id_kub=b.id_kub where status_umat='Ada' AND p.jenis_kelamin='LK'");
